...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private String extractJwtToken(HttpServletRequest request) {
        ...
        } else if (requestURI.contains("/api/files/vedios/") || requestURI.contains("/api/files/image/") && request.getParameter("token")!= null) {
    ...
    private UserDetails createUserDetails(String jwt, String username) {
        ...
        return User.builder().username(username).password("").authorities(Collections.singletonList(new SimpleGrantedAuthority("ROLE" + role))).build();
    }
